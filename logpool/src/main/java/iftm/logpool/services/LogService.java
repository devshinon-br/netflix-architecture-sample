package iftm.logpool.services;

import iftm.logpool.models.dto.LogDTO;
import iftm.logpool.models.dto.NewsDTO;
import iftm.logpool.repositories.LogRepository;
...
public class LogService {
    ...
    public ResponseEntity<List<LogDTO<NewsDTO>>> findAll() {
        ...
        if (dbLogs == null || dbLogs.size() == 0) return new ResponseEntity<>(HttpStatus.NOT_FOUND);
